        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
               ...
               <p className="text-gray-600 mb-6 leading-relaxed">
                 Operiamo nel settore delle ristrutturazioni d’interni di alto profilo, specializzandoci in interventi per <strong>ville private, hotel di lusso e residenze storiche</strong> sul Lago di Como. Il nostro approccio combina le tecniche tradizionali della manodopera italiana con i materiali più innovativi del mercato.
               </p>
               <p className="text-gray-600 mb-6 leading-relaxed">
                 Ogni progetto è un viaggio che intraprendiamo con il cliente: dall'ascolto delle esigenze alla progettazione tecnica, fino alla consegna "chiavi in mano". La nostra forza risiede nella gestione completa del cantiere, garantendo tempi certi e finiture impeccabili.
               </p>
               
               <h3 className="font-serif text-2xl text-gray-900 mt-8 mb-4">I Nostri Valori</h3>
               <ul className="list-disc pl-5 space-y-2 text-gray-600">
                  <li><strong>Eccellenza:</strong> Non accettiamo compromessi sulla qualità finale.</li>
                  <li><strong>Trasparenza:</strong> Preventivi chiari e comunicazione costante durante i lavori.</li>
                  <li><strong>Sostenibilità:</strong> Utilizzo di materiali a basso impatto ambientale e certificati.</li>
                  <li><strong>Territorialità:</strong> Profonda conoscenza del tessuto architettonico del Lario.</li>
               </ul>
            </div>
        </div>
      </div>
